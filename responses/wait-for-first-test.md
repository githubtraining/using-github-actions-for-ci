...
When the tests finish you'll see a red :x: or a green :heavy_check_mark: in the merge box. At that point, you'll have access to logs for build job and its associated steps. 
